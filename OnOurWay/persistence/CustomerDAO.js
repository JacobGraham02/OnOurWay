...
const getAllFromCustomerTable = function() {
...
const getSpecificCustomerFromCustomerTable = function(where) {
...
const updateCustomer = function(query_data) {
    const partial_sql_string = concatenateSqlQueryStringForUpdate(query_data.column_names, query_data.column_values, query_data.total_columns);
    const where_clause_string = concatenateSqlQueryStringForWhereClause(query_data.where_clause);
    let query_string = `UPDATE CUSTOMER SET ${partial_sql_string} WHERE ${where_clause_string}`;
    return new Promise(function(resolve, reject) {
        database_manager.initialize_database_connection_pool.getConnection(function(error, connection) {
            connection.query(query_string, function(error, results) {
                if (error) {
...
exports.getAllFromCustomerTable = getAllFromCustomerTable;
exports.getSpecificCustomerFromCustomerTable = getSpecificCustomerFromCustomerTable;
